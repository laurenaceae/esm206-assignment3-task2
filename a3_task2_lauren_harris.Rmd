...
- It will drop the piece of the name after the 2nd dash
...
gasol_hookshots_recorded <- gasol_hookshots %>% 
  count(month)

gasol_hookshots_recorded %>% 
  kable(col.names = c("Month", "Number of Hookshot attempts"), caption = "Paul Gasol's attempted hookshots for the 2008 - 2009 season") %>% 
